...
function Contacto(){
    ...
    const formSubmitted=(event)=>{
        ...
        console.log("Probando portafolio")
...
return(
    <div className="container my-4">
        ...
        <form className="form p-4 needs-validation" id="contacto" onSubmit={formSubmitted}>
            <div className="row">
                <div className="mb-3 col-6">
                    <label className="form-label">Nombre</label>
                    <input type="text" className="form-control" id="validationName" onChange={takeName} value={enteredName} required />
                </div>
                <div className="mb-3 col-6">
                    <label className="form-label">Apellido</label>
                    <input type="text" className="form-control" onChange={takeLastName} value={enteredLastName} required />
                </div>
            </div>
            <div className="mb-3">
                <label className="form-label">Email</label>
                <input type="email" className="form-control" placeholder="name@example.com" onChange={takeEmail} value={enteredEmail} required />
            </div>
            <div className=" d-flex flex-column mb-1">
                <label className="form-label">Mensaje</label>
                <textarea className="form-control" rows="5" onChange={takeMessage} value={enteredMessage} required></textarea>
            </div>
